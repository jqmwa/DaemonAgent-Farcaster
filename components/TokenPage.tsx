    ...
    >
      ...
      <div className="w-full mb-4">
        <button
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(120, 138, 255, 0.15) 0%, rgba(18, 18, 26, 0.9) 100%)',
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7 16V4M7 4L3 8M7 4L11 8M17 8V20M17 20L21 16M17 20L13 16" stroke="#788AFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <span className="text-sm font-semibold uppercase" style={{ fontFamily: "'Press Start 2P', monospace", color: '#788AFF' }}>
            Swap $DAEMON
          </span>
        </button>
      </div>
